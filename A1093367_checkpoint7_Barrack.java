...
public class A1093367_checkpoint7_Barrack extends JLabel implements Runnable {
    ...
    public A1093367_checkpoint7_Barrack(int locationX, int locationY, String text, int scaler, int horizontalAlignment) {
